    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(196, 57, 145, 0.24) 0%, rgba(90, 183, 214, 0.18) 38%, rgba(88, 101, 242, 0.08) 55%, transparent 72%)",
      ...
      <div
        style={{
          ...
          boxShadow:
            "0 8px 32px rgba(0, 0, 0, 0.5), 0 0 16px rgba(196, 57, 145, 0.28), 0 0 16px rgba(90, 183, 214, 0.2)",
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
          position: "relative",
        ...
        >
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(circle at 65% 70%, rgba(90, 183, 214, 0.25) 0%, rgba(196, 57, 145, 0.22) 50%, transparent 80%)",
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(circle, rgba(0,0,0,0) 65%, rgba(10,12,20,0.3) 90%, rgba(10,12,20,0.55) 100%)",
              pointerEvents: "none",
              zIndex: 1,
            }}
          />
