...
function Overlay() {
      ...
      >
        <div style={{ display: "flex", gap: "8px" }}>
          <button
            type="button"
            onClick={() => {
              dictationStatus.status.value = "Recording";
            }}
            style={{
              border: "none",
              borderRadius: "8px",
              padding: "8px 12px",
              background:
                dictationStatus.status.value === "Recording" ? "#5865f2" : "rgba(255,255,255,0.12)",
              color: "#fff",
              cursor: "pointer",
            }}
          >
          ...
          <button
            type="button"
            onClick={() => {
              dictationStatus.status.value = "Transcribing";
            }}
            style={{
              border: "none",
              borderRadius: "8px",
          ...
          <button
            type="button"
            onClick={() => {
              dictationStatus.status.value = "Error";
            }}
            style={{
              border: "none",
              borderRadius: "8px",
              padding: "8px 12px",
              background:
                dictationStatus.status.value === "Error" ? "#ef4444" : "rgba(255,255,255,0.12)",
              color: "#fff",
              cursor: "pointer",
            }}
          >
  ...
  return (
    ...
    >
      <StatusIndicator
        status={dictationStatus.status.value}
        size={44}
        fixedWidth={180}
        subtitle={
          dictationStatus.status.value === "Recording" && hotkeyMode.value === "Toggle"
            ? "press again to stop"
            : undefined
        }
      />
