              ...
              <div style={{ position: "relative", width: "100%", height: "100%" }}>
                <div
                  style={{
                    position: "absolute",
                    inset: 0,
                    opacity: dictationStatus === "Ready" ? 1 : 0,
                    transition: "opacity 0.2s ease",
                    pointerEvents: dictationStatus === "Ready" ? "auto" : "none",
                  }}
                >
                ...
                <div
                  style={{
                    position: "absolute",
                    inset: 0,
                    opacity: dictationStatus === "Recording" ? 1 : 0,
                    transition: "opacity 0.2s ease",
                    pointerEvents: dictationStatus === "Recording" ? "auto" : "none",
                  }}
                >
              ...
              >
                ...
                {dictationStatus === "Ready" && config.hotkey ? (
                  ...
                  >
                    ...
                    <span style={{ color: "#818cf8", fontWeight: 600 }}>{config.hotkey}</span>
                    {" to start dictation"}
                  </div>
                ) : (
                  <div
              ...
              >
                ...
                >
                  <input
                    ...
                    onChange={(e) => {
                      e.stopPropagation();
                      onToggleDiarization((e.target as HTMLInputElement).checked);
                    }}
          ...
          {importStatus.value === "done" && importResult.value && (
            <>
              <div
                style={{
                  fontSize: tokens.typography.sizeXs,
                  color: tokens.colors.success || "#43b581",
                  marginBottom: "4px",
                }}
              >
                Transcription complete{" "}
                {importResult.value.provider !== "none" && `(${importResult.value.provider})`}
              </div>
              <div
                style={{
                  fontSize: tokens.typography.sizeSm,
              ...
              <div
                style={{ display: "flex", gap: tokens.spacing.sm, marginTop: tokens.spacing.xs }}
              >
                <button
                  onClick={(e) => {
                    e.stopPropagation();
        ...
        >
          <div style={{ display: "flex", gap: tokens.spacing.sm, alignItems: "center" }}>
            <button
              ...
              onMouseEnter={() => {
                hoveredFooterIcon.value = "github";
              }}
              onMouseLeave={() => {
                hoveredFooterIcon.value = null;
              }}
              title="GitHub Repository"
              style={{
                background:
                  hoveredFooterIcon.value === "github" ? "rgba(255, 255, 255, 0.05)" : "none",
                border: "none",
                padding: "10px",
                cursor: "pointer",
                color:
                ...
                borderRadius: "50%",
                transform:
                  hoveredFooterIcon.value === "github" ? "translateY(-2px)" : "translateY(0)",
                transition: tokens.transitions.fast,
              }}
            >
            ...
            <button
              ...
              style={{
                background:
                  hoveredFooterIcon.value === "heart" ? "rgba(255, 255, 255, 0.05)" : "none",
                border: "none",
                padding: "10px",
                cursor: "pointer",
                ...
                borderRadius: "50%",
                transform:
                  hoveredFooterIcon.value === "heart" ? "translateY(-2px)" : "translateY(0)",
                transition: tokens.transitions.fast,
              }}
            >
              <IconHeart
