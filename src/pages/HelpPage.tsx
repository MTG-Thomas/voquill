  ...
  const howToSteps = [
    ...
    isToggleMode ? (
      isSystemManagedShortcut ? (
        ...
        <>
          <span>Press </span>
          <strong style={{ color: "#818cf8" }}>{config.hotkey}</strong>
        ...
        <Card>
          ...
          >
            ...
            >
              ...
              <span>
                Hold to talk pauses recording when you stop speaking; toggle mode records until you
            ...
            >
              ...
              <span>
                Enable "Differentiate voices" on the file upload or in Settings under Transcription
                to label speakers in imported files. Enable it in Settings under Transcription for
                in-app recordings (may be slower).
              </span>
            </li>
          </ul>
        </Card>
