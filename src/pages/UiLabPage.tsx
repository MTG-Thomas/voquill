  ...
  return (
    <div style={{ ...tabPanelStyle, position: "relative" }}>
      ...
      >
        ...
        <ConfigField label="Status Indicator" description="Live status indicator with animations.">
          <div style={{ display: "flex", gap: tokens.spacing.sm, alignItems: "center" }}>
            ...
            <SelectField
              ...
              onChange={(v) => {
                activeStatus.value = v as "Ready" | "Recording" | "Transcribing";
              }}
              style={{ width: "180px" }}
            />
          </div>
        ...
        <ConfigField
          label="Update Badge"
          description="Show update-available indicator on Status tab."
        >
          <Switch
            name="Update Badge"
            checked={showUpdateBadge.value}
            onChange={(v) => {
              showUpdateBadge.value = v;
            }}
          />
        </ConfigField>
        ...
        <ConfigField label="SelectField (searchable)" description="Searchable dropdown.">
          <SelectField
            ...
            options={[
              ...
              {
                value: "disabled-kappa",
                label: "Kappa (disabled)",
                searchText: "disabled",
                disabled: true,
              },
            ]}
        ...
        <ConfigField
          label="ModeSwitcher"
          description="Toggle between Typewriter and Clipboard modes."
        >
          <ModeSwitcher
            value={outputMethod.value}
            onToggle={(v) => {
              outputMethod.value = v;
            }}
            options={[
        ...
        <ConfigField label="Buttons" description="All button variants.">
          ...
          >
            ...
            <Button variant="ghost" pill onClick={() => {}}>
              Ghost
            </Button>
            ...
            <Button variant="primary" pill disabled>
              Disabled
            </Button>
          </div>
        </ConfigField>
        ...
        <ConfigField label="Switch" description="Toggle switch.">
          <Switch
            name="Demo Switch"
            checked={isDemoSwitchOn.value}
            onChange={(v) => {
              isDemoSwitchOn.value = v;
            }}
          />
        </ConfigField>
        ...
        <ConfigField
          label="Ready Sweep"
          description="Horizontal sweeping line animation for ready state."
        >
          <div
            style={{
              width: "120px",
        ...
        <ConfigField
          label="Jumping Dot"
          description="Brand-gradient jumping dot for the ready state."
        >
          <div
            style={{
              width: "120px",
        ...
        <ConfigField
          label="Audio Wave"
          description="Animated audio visualizer using Voquill brand colors."
        >
          <div
            style={{
              width: "120px",
        ...
        <ConfigField
          label="Bouncing Dots"
          description="Bouncing dots animation for transcribing state."
        >
          <div
            style={{
              width: "120px",
        ...
        <ConfigField
          label="Status Icon Comparison"
          description="Compare the old status orb, the new audio wave design, and the overlay pill."
        >
          <div
            style={{
              display: "flex",
