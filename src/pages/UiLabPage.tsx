    ...
    <div style={{ ...tabPanelStyle, overflow: "auto", padding: 0 }}>
      ...
      >
        <Card>
          <div style={{ display: "flex", flexDirection: "column", gap: tokens.spacing.xs }}>
            ...
            >
              <Button variant="ghost" pill onClick={onBackToSettings}>
                Back to Settings
              </Button>
              <Button variant="primary" pill onClick={() => setIsModalOpen(true)}>
                Open Internal Modal
              </Button>
              <Button variant="secondary" pill onClick={onOpenUpdateModal}>
                Open Real Update Modal
              </Button>
            </div>
          </div>
        </Card>
        ...
        <Card>
          <div style={{ display: "grid", gap: tokens.spacing.sm }}>
            <div style={{ fontSize: tokens.typography.sizeMd, fontWeight: 700 }}>
              Status / Update Preview
            </div>
            <div style={{ display: "flex", flexWrap: "wrap", gap: tokens.spacing.sm }}>
              <Button variant="ghost" pill onClick={() => setActiveStatus("Ready")}>
                Ready
              </Button>
              <Button variant="ghost" pill onClick={() => setActiveStatus("Recording")}>
                Recording
              </Button>
              <Button variant="ghost" pill onClick={() => setActiveStatus("Transcribing")}>
                Transcribing
              </Button>
            </div>
            <div style={{ display: "flex", gap: tokens.spacing.sm, flexWrap: "wrap" }}>
              <Switch
                ...
                onChange={setShowUpdateBadge}
                label="Show update badge"
              />
            </div>
            <div style={{ display: "flex", gap: tokens.spacing.sm, flexWrap: "wrap" }}>
              <Switch
                checked={updateAvailableCopy}
                onChange={setUpdateAvailableCopy}
                label="Use update-available copy"
              />
            </div>
            <div
              style={{
        ...
        <Card>
          <div style={{ display: "grid", gap: tokens.spacing.sm }}>
            ...
            >
              ...
              <Button variant="icon" title="Icon">
                i
              </Button>
              <Button variant="titlebarIcon" title="Minimize">
                <IconMinus size={14} stroke={2.2} />
              </Button>
              <Button variant="titlebarClose" title="Close">
        ...
        <Card>
          <div style={{ display: "grid", gap: tokens.spacing.sm }}>
            ...
            <ConfigField
              label="Model Selection Panel"
              description="Model picker, description, and download action."
            >
              <ModelSelectionPanel
        ...
        <Card>
          <div style={{ display: "grid", gap: tokens.spacing.sm }}>
            ...
            >
              <div
                style={{ color: tokens.colors.textSecondary, fontSize: tokens.typography.sizeSm }}
              >
            ...
            >
              <ActionFooter>
                <Button variant="danger" pill floating>
      ...
      {isModalOpen && (
        <Modal
          ...
          footer={
            <>
              <Button variant="ghost" pill onClick={() => setIsModalOpen(false)}>
                Later
              </Button>
              <Button variant="primary" pill onClick={() => setIsModalOpen(false)}>
                Download Latest
              </Button>
            </>
          }
