  ...
  return (
    <>
          ...
          options={[
            {
              value: "Clipboard",
              label: "Clipboard",
              title: "Copy transcription results to your clipboard (Fast & Reliable)",
            },
            {
              value: "Typewriter",
              label: "Typewriter",
              title: "Type directly into your active cursor via simulated keystrokes",
            },
          ]}
        />
      </ConfigField>
      ...
      {config.output_method === "Clipboard" && (
        <>
          <ConfigField
            label="Paste After Copy"
            description="Automatically paste after copying. Saves and restores your prior clipboard content."
          >
            <Switch
          ...
          {config.paste_after_copy && (
            <ConfigField
              ...
              description="Keyboard shortcut simulated to paste your transcription into the active application."
            >
              <div style={selectWrapperStyle}>
                <SelectField
                  ...
                  onChange={(nextShortcut) =>
                    updateConfig("paste_shortcut", nextShortcut as PasteShortcut)
                  }
      ...
      {config.output_method === "Typewriter" && (
        <>
          <ConfigField
            ...
            description="Also copy transcriptions to clipboard while typing directly into your active cursor."
          >
            <Switch
          ...
          <ConfigField
            label="Key Hold Duration (ms)"
            description="How long each virtual key is held down before release."
          >
            <NumberField
      ...
      <ConfigField
        ...
        description="Automatically append a space after typed text so you're ready to type the next word."
      >
        <Switch
          name="Append Trailing Space"
          checked={config.append_trailing_space}
          onChange={(checked) => updateConfig("append_trailing_space", checked)}
        />
      </ConfigField>

      <ConfigField
        label="Auto-Submit with Enter"
        description="Automatically press Enter after dictation finishes to submit the message or command."
      >
        <Switch
          name="Auto-Submit"
          checked={config.auto_submit}
          onChange={(checked) => updateConfig("auto_submit", checked)}
        />
      </ConfigField>
    </>
  );
