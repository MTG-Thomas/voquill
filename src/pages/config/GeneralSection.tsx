          ...
          options={[
            {
              value: "HoldToTalk",
              label: "Hold to Talk",
              title: "Record while the hotkey is held down",
            },
            {
              value: "Toggle",
              label: "Press to Toggle",
              title: "Press once to start recording, press again to stop",
            },
          ]}
        />
      </ConfigField>
      ...
      <ConfigField
        ...
        description={
          config.hotkey_mode === "Toggle"
            ? isSystemManagedShortcut
              ? "Press your system shortcut to start recording, and again to stop."
