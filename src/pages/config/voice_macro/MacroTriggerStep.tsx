  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "14px", width: "100%" }}>
      ...
      >
        ...
        >
          <li>
            <strong>Use 2–4 words:</strong> Short, distinct commands like <em>"take screenshot"</em>{" "}
            work best.
          </li>
          <li>
            <strong>Add Aliases:</strong> Add common variations (e.g. <em>"grab screenshot"</em>) so
