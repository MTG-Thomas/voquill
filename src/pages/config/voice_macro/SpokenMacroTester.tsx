  ...
  return (
    ...
    >
      ...
      >
        ...
        <span>
          <strong>Dictionary Tip:</strong> If Whisper mishears specific words (e.g., "Coal" instead
          of "Call" or game terms), adding them to <strong>Settings ➔ Dictionary</strong> primes the
          speech model to transcribe them with 100% accuracy.
        </span>
      </div>
    </div>
  );
