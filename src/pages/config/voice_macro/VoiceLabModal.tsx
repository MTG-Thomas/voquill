...
export function VoiceLabModal({ onClose, onPresetSaved }: VoiceLabModalProps) {
  ...
  const text = useSignal(
    "Titan online. Core temperature nominal. All weapon systems combat ready.",
  );
            ...
            {isMultiSpeaker && (
              ...
              >
                ...
                <SliderField
                  ...
                  onChange={(val) => {
                    speakerId.value = Math.round(val);
                  }}
                  hideEndLabels
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                ...
                >
                  ...
                  <span style={{ fontFamily: "monospace", color: "#c7d2fe" }}>
                    {pitch.value > 0 ? `+${pitch.value}` : pitch.value} st
                  </span>
                </div>
                <SliderField
                  min={-12}
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                <label
                  style={{ fontSize: "11px", fontWeight: 600, color: tokens.colors.textMuted }}
                >
              ...
              savedPresets.value.map((p) => (
                ...
                >
                  <div style={{ minWidth: 0, flex: 1 }}>
                    ...
                    >
                      {p.model_key} • Pitch: {p.pitch}st • Speed: {p.speed}x • Radio:{" "}
                      {p.radio_bandpass ? "Yes" : "No"}
                    </div>
                  </div>
