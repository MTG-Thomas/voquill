  ...
  return (
    <>
      ...
      <ConfigField
        ...
        description="Choose the output device for mic test playback and history audio listening."
      >
        <div style={selectWrapperStyle}>
          <SelectField
          ...
          <Button
            variant="icon"
            onClick={loadSpeakers || loadMics}
            title="Refresh Playback Devices"
          >
            <IconRefresh size={16} />
          </Button>
        </div>
      ...
      >
        <MicSetupPanel
          ...
          onVoiceMacroActivationThresholdChange={(value) =>
            updateConfig("voice_macro_activation_threshold", value)
          }
      ...
      <ConfigField
        ...
        description="Reduce background noise from your microphone using spectral gating. Improves transcription accuracy in noisy environments."
      >
        <div
          style={{
            display: "flex",
        ...
        >
          <Switch
            ...
            checked={config.noise_reduction_enabled}
            onChange={(checked) => updateConfig("noise_reduction_enabled", checked)}
          />
